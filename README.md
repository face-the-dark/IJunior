...
<summary>Создать эффект удар</summary><br>

Представим, что мы делаем файтинг

В процессе игры игрок может нанести удар по противнику или по другому объекту. Нужно создать эффект удара
...
<summary>Создание эффекта блёсток</summary><br>
...
<summary>Творческое задание</summary><br>

Создать свой собственный эффект

Эффект обязательно должен иметь сложное поведение и включать в себя модули, что мы изучили 

(не обязательно все, тут смотрите по нужде)
